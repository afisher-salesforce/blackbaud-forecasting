const TRAILHEAD_VERIFIED_AT = "2026-08-08";

const TRAILHEAD_RECOMMENDATIONS_BY_CODE = {
  SSP: [
    {
      ...
      lastVerifiedAt: TRAILHEAD_VERIFIED_AT
    }
  ],
  SOP: [
    {
...
function getEnablementForCodes(codes, maxItems = 3) {
  const seen = new Set();
  const collected = [];
  codes.forEach((code) => {
...
window.TrailheadEnablement = {
  verifiedAt: TRAILHEAD_VERIFIED_AT,
  byCode: TRAILHEAD_RECOMMENDATIONS_BY_CODE,
